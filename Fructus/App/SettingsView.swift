            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        ...
                        SettingsRowView(name: "Designer", content: "Jeluchu")
                        SettingsRowView(name: "Compatibility", content: "iOS 14.5")
                        SettingsRowView(name: "Website", linkLabel: "GitHub", linkDestination: "github.com/Jeluchu")
                        SettingsRowView(name: "Twitter", linkLabel: "@Jeluchu", linkDestination: "twitter.com/Jeluchu")
